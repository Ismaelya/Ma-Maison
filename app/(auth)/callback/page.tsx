  ...
  useEffect(() => {
    async function handle() {
      try {
        ...
        // Try to parse a session from the URL (handles magic link / recovery)
        // This will read the URL fragment and store session in local storage.
        // If a standard OAuth `code` was used, the server route will handle it.
        ...
        // If data.session exists, redirect to next (or connexion)
