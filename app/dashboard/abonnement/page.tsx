    ...
    <div className="animate-fade-in space-y-8">
      ...
      {!premiumEnabled ? (
        <div className="space-y-6">
          ...
          <div
            className="rounded-2xl border border-blue-200 dark:border-blue-900/50 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/40 dark:to-indigo-950/40 p-6 shadow-[var(--shadow-card)]"
          >
          ...
          <div className="rounded-2xl border border-amber-200 dark:border-amber-900/50 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/40 dark:to-orange-950/40 p-8 text-center shadow-[var(--shadow-card)]">
            ...
            <h2 className="text-xl font-bold text-amber-900 dark:text-amber-300">Premium — Bientôt disponible</h2>
            <p className="mt-3 text-sm text-amber-800 dark:text-amber-400 leading-relaxed max-w-md mx-auto">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            ...
            <div
              className={cn(
                ...
                status === "active"
                  ? "border-green-200 dark:border-green-900/50 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/40 dark:to-emerald-950/40"
                  : status === "free"
                    ? "border-blue-200 dark:border-blue-900/50 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/40 dark:to-indigo-950/40"
                    : "border-red-200 dark:border-red-900/50 bg-gradient-to-br from-red-50 to-rose-50 dark:from-red-950/40 dark:to-rose-950/40"
              )}
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  {(profile.badgeVerified || (profile as any).badge_verified) && (
                    <span className="flex items-center gap-1 rounded-full bg-blue-100 dark:bg-blue-900/40 px-3 py-1 text-xs font-bold text-blue-700 dark:text-blue-300">
            ...
            <div className="rounded-2xl border border-[var(--border)] bg-white p-6 shadow-[var(--shadow-card)]">
              ...
              <div className="mt-4 overflow-hidden rounded-xl border border-neutral-200">
                <table className="w-full text-xs">
                  ...
                  <tbody className="divide-y divide-[var(--color-border)] text-neutral-700">
                    <tr>
                ...
                <div className="rounded-xl border border-orange-200 dark:border-orange-900/50 bg-orange-50/50 dark:bg-orange-950/20 p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-ivory p-1 shadow-sm border border-orange-100">
                        <img src="/images/amana.jpg" alt="Amanata" className="h-full w-full object-contain" />
                      </div>
                      <span className="font-bold text-orange-900 dark:text-orange-300">Amanata</span>
                    </div>
                    <span className="rounded-lg bg-orange-200/80 dark:bg-orange-900/50 px-3 py-1 text-xs font-bold text-orange-800 dark:text-orange-300">
                      {amanataPhone}
                    </span>
                  </div>
                  <p className="mt-2 text-xs text-orange-700 dark:text-orange-400"></p>
                </div>

                <div className="rounded-xl border border-purple-200 dark:border-purple-900/50 bg-purple-50/50 dark:bg-purple-950/20 p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-ivory p-1 shadow-sm border border-purple-100">
                        <img src="/images/nita.png" alt="Mynita" className="h-full w-full object-contain" />
                      </div>
                      <span className="font-bold text-purple-900 dark:text-purple-300">Mynita</span>
                    </div>
                    <span className="rounded-lg bg-purple-200/80 dark:bg-purple-900/50 px-3 py-1 text-xs font-bold text-purple-800 dark:text-purple-300">
                      {mynitaPhone}
                    </span>
                  </div>
                  <p className="mt-2 text-xs text-purple-700 dark:text-purple-400"></p>
                </div>

                <div className="rounded-xl border border-blue-200 dark:border-blue-900/50 bg-blue-50/50 dark:bg-blue-950/20 p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-ivory p-1 shadow-sm border border-blue-100">
                        <img src="/images/wave.png" alt="Wave" className="h-full w-full object-contain" />
                      </div>
                      <span className="font-bold text-blue-900 dark:text-blue-300">Wave</span>
                    </div>
                    <span className="rounded-lg bg-blue-200/80 dark:bg-blue-900/50 px-3 py-1 text-xs font-bold text-blue-800 dark:text-blue-300">
                      {wavePhone}
                    </span>
                  </div>
                  <p className="mt-2 text-xs text-blue-700 dark:text-blue-400"></p>
                </div>
              </div>
